...
<head>
	...
	<body>
		<div align="center">
		<br><br>
		<form name="regFrm" method="post" action="group01Proc.jsp">
			<table align="center" valign="middle">
				<tr><td align="center" valign="middle">
					<table border="1" cellpadding="2" align="center" width="600">
						<span align="center">※단체 관리자만 입력※<br><br></span>
						<tr align="center" bgcolor="#dde6d5">
							<td colspan="2"><h2>단체 입력</h2></td>
						</tr>
						<tr>
						...
						<tr>
							<td>단체 코드</td>
							<td><input name="grnum" size="15" placeholder="A0001-01 형태로 입력"></td>
						</tr>
						<tr>
							<td>단체 이름</td>
							<td><input name="grname" size="15" placeholder="단체 이름 입력"></td>
						</tr>
						<tr>
							<td>단체 장소</td>
							<td><input name="grplace" size="15" placeholder="단체 장소 입력"></td>
						</tr>
						<tr>
							<td>단체 관리자 아이디</td>
